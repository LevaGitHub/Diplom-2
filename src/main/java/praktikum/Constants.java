...
public class Constants {
    ...
    public static final String MSG_USER_REMOVE_SUCCESS = "User successfully removed";
    ...
    public static final String MSG_INGREDIENT_MUST_BE_PROVIDED = "Ingredient ids must be provided";

    public static final String BUN_ID = "61c0c5a71d1f82001bdaaa6d";
    public static final String MAIN_ID = "61c0c5a71d1f82001bdaaa6f";
